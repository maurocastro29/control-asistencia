<x-app-layout>
    <x-layout.page-header title="Horarios Laborales" subtitle="Detalle del Horario laboral">
        <x-slot:actions>
            @can('work-schedules.edit')
                <x-button.primary :href="route('work-schedules.edit', $workSchedule->id)">
                    Editar
                </x-button.primary>
            @endcan
        </x-slot:actions>
                ...
                <x-table.table>
                    <x-table.head>
                        <x-table.row>
                            ...
                            <x-table.th>Ordinaria</x-table.th>
                        </x-table.row>
                    </x-table.head>
                    <x-table.body>
